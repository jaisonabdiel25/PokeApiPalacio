  ...
  const App = {
    ...
    handlers: {
      ...
      cleanTemplate: (e) => {
        ...
        document.querySelector("#pokemon-finder-response").value = '';
      }
    },
    evolution: {
    ...
    templates: {
      ...
      pokemonCard: ({ id, name, weight, height, sprites, abilities }) => {
        ...
        abilietieList = abilities.map(
          (element) => `<li>${element.ability.name} ${element.is_hidden ? App.htmlElements.hidden : ""}</li>`
        );
        return ` 
                  ...
                  <h1>${name} (${id})</h1>
                    ...
                    <div class="info-sprites">
                      ...
                      <div class="sprites">
                        ...
                        <img  class="sprite-two" alt="PokéAPI"src="${sprites.front_default}"/>
                      </div>
                    </div>
